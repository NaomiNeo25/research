...
from DLP import get_dataloaders,  IMDb62Dataset
from models import *
import pandas as pd
import os
...
# Set up directories
SAVE_DIR = "./experiment_results/IMDBDataset/"
os.makedirs(SAVE_DIR, exist_ok=True)
...
datasets = {
    "IMDB": {"class": IMDb62Dataset,
             "args": {"data_file": './datasets/imdb62/imdb62.txt', "sp_model": sp, "max_seq_length": 512}},
}
